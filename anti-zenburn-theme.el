...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(newsticker-treeview-new-face ((,class (:foreground ,azenburn-beige :weight bold))))
   ...
   `(ac-selection-face ((,class (:background ,azenburn-beige-4 :foreground ,azenburn-fg))))
   `(popup-tip-face ((,class (:background ,azenburn-dark-blue-2 :foreground "white"))))
   `(popup-scroll-bar-foreground-face ((,class (:background ,azenburn-beige-5))))
   ...
   `(eshell-ls-directory ((,class (:foreground ,azenburn-beige+1 :weight bold))))
   ...
   `(erc-current-nick-face ((,class (:foreground ,azenburn-beige :weight bold))))
   ...
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,azenburn-beige+1))))
   ...
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,azenburn-beige-2))))
   ...
   `( rainbow-delimiters-depth-12-face ((,class (:foreground ,azenburn-beige-5))))
   ...
   `(show-paren-match ((,class (:foreground ,azenburn-beige-1 :background ,azenburn-bg :weight bold))))
   ...
   `(wl-highlight-message-cited-text-3 ((,class (:foreground ,azenburn-beige))))
   `(wl-highlight-message-cited-text-4 ((,class (:foreground ,azenburn-beige+1))))
   ...
   `(wl-highlight-summary-answered-face ((,class (:foreground ,azenburn-beige))))
